package org.br.generation.blogpessoal.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("org.br.generation.blogpessoal.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("API - Isabella's Personal Blog")
			.description("Welcome To My Personal Blog")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("https://github.com/isabellammarinho")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Isabella Marinho", 
			"https://github.com/isabellammarinho", 
			"isabellamarcelomarinho@gmail.com");
